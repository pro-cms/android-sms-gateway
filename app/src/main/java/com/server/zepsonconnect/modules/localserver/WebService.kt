...
import com.server.zepsonconnect.modules.localserver.domain.Device
import com.server.zepsonconnect.modules.localserver.routes.LogsRoutes
import com.server.zepsonconnect.modules.localserver.routes.MessagesRoutes
import com.server.zepsonconnect.modules.localserver.routes.WebhooksRoutes
    ...
    private val server by lazy {
        embeddedServer(
            ...
            install(ContentNegotiation) {
                gson {
                    if (com.server.zepsonconnect.BuildConfig.DEBUG) {
                        setPrettyPrinting()
                    }
                    configure()
                }
            ...
            routing {
                ...
                authenticate("auth-basic") {
                    ...
                    route("/settings") {
                        com.server.zepsonconnect.modules.localserver.routes.SettingsRoutes(get())
                            .register(this)
                    }
                }
            }
